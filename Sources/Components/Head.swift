...
struct Head<InjectedComponent: Component>: Component {
    ...
    var body: some Component {
        Tag("head") {
            ...
            Tag("script") {
                """
                function getSessionId(){const e="_sid";let t=sessionStorage.getItem(e);return t||(t=Math.random().toString(36).slice(2)+Date.now().toString(36),sessionStorage.setItem(e,t)),t}navigator.sendBeacon("https://d.khanwinter.com/metrics",JSON.stringify({url:location.href,referrer:document.referrer,userAgent:navigator.userAgent,language:navigator.language,timezone:Intl.DateTimeFormat().resolvedOptions().timeZone,sessionId:getSessionId()}));
                """
            }
